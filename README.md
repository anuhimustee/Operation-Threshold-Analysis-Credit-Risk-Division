...
## Recommendations
• Tighten approval criteria above ~35% DTI (the High/Severe boundary) — this is where default risk and money at risk both concentrate. Owner: Underwriting. (action)
• Treat debt-to-income, not credit score alone, as the primary risk signal once a loan is large relative to income. Owner: Underwriting. (action)
• Give SME applications and the Manchester/Newcastle branches extra review. Owner: Portfolio risk. (action)
• Use a missed first payment as a prompt for early borrower contact, not as grounds to flag the loan as high-risk. Owner: Servicing / collections. (action)
• Don't rank or act on individual loan officers from this data. Only 3 of 40 are statistically distinguishable from average. Owner: Risk Committee. (action)
